...
public class Reindex {
    ...
    public static void main(String... args) throws Exception {
        ...
        try (RestHighLevelClient client = AlaElasticsearchUtils.newElasticsearchClient(esHostname,
                esPort, esScheme);) {
            doReindex(client, sourceIndex, destinationIndex);
        }
    }
    ...
    public static void doReindex(RestHighLevelClient client, String sourceIndex,
            String destinationIndex) throws IOException, InterruptedException {
        final String taskId = Reindex.asyncReindex(client, sourceIndex, destinationIndex);
